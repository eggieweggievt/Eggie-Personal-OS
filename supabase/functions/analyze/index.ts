...
- navigate: { tab: "home"|"content"|"planner"|"calendar"|"optimize"|"script"|"habits"|"health"|"care"|"food"|"fitness"|"art"|"tools"|"income"|"pitch"|"clients"|"cplanner"|"ccalendar"|"chelp"|"review"|"eugene"|"settings" }   // navigating to a tab from another mode flips the mode automatically; cplanner/ccalendar/chelp = the Sakura tasks + calendar + guide tabs
