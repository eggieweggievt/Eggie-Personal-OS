...
- navigate: { tab: "home"|"content"|"planner"|"calendar"|"optimize"|"script"|"habits"|"health"|"care"|"food"|"fitness"|"art"|"tools"|"income"|"pitch"|"clients"|"cplanner"|"ccalendar"|"review"|"eugene"|"settings" }   // navigating to a tab from another mode flips the mode automatically; cplanner/ccalendar = the Sakura tasks + calendar tabs
